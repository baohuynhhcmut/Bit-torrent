...
function createBitfieldFromList(pieces, torrent, piecesBuffer){
    ...
    console.log("createBitfieldFromList")
...
function uninterestedHandler(socket, torrent){
    ...
    console.log("uninterestedHandler")
