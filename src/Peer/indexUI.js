...
module.exports.runProcess =  (torrentPath,args,win,ipcMain) => {
    ...
    // console.log("Đây là Torrent: ",torrent)
    ...
    // console.log("Đây là fileInfoList: ",fileInfoList)
    ...
    async function processFile() {
        try {
            ...
            const port = genPort(torrentParser.inforHash(torrent))
            // console.log(port)
            const peerServer = server(port,torrent, pieces, sharedPieceBuffer);
